...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "High-level results from adaptive red teaming across multi-agent workflows, including verified attack success, cross-target transfer, and practical lessons for defenders.",
    category: "Research",
    categoryColor: "slate",
    readTime: "8 min read",
    date: "April 14, 2026",
