...
export function AttackSurface() {
  return (
    <section className="bg-slate-50 px-4 py-24 sm:px-6 lg:px-8 lg:py-32 bg-dot-pattern-light">
          ...
          {threats.map((threat, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-5 text-xl font-bold tracking-tight text-slate-900">{threat.title}</h3>
                <p className="mt-1 font-mono text-xs text-slate-500">{threat.stat}</p>
                <p className="mt-4 text-sm leading-relaxed text-slate-600">{threat.description}</p>
              </motion.div>
            )
          })}
        </div>
