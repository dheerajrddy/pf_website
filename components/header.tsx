...
const navGroups = [
  {
    ...
    links: [
      ...
      { label: "Automated Red Teaming", href: "/#red-team", detail: "Scheduled attacks across deployed AI systems" },
      { label: "MCP Runtime Security", href: "/#runtime-security", detail: "Inline protection during serving and inference" },
    ],
  },
]
    ...
    <header className={`fixed inset-x-0 top-0 z-50 bg-white/80 backdrop-blur-2xl transition-[border-color] ${scrolled ? "border-b border-gray-100/80" : "border-b border-transparent"}`}>
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-2">
          <Image src="/logo.png" alt="ProofLayer Logo" width={40} height={40} className="rounded-lg" />
