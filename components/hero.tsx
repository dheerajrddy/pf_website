      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:gap-10">
          <div className="flex h-full flex-col">
            <h1 className="text-[48px] font-extrabold leading-[1.02] tracking-tighter text-gray-900 sm:text-[68px] lg:text-[68px]">
              Prove your AI
              <br />
              is secure.
              <br />
            ...
            <div className="mt-auto flex flex-col items-start gap-3 pt-7 sm:flex-row sm:items-center sm:gap-4">
          ...
          <div className="hidden lg:block">
            <Image
              src="/prooflayer-architecture.svg"
              alt="ProofLayer architecture: three products feed one security plane and one vulnerability report"
              width={720}
              height={610}
              sizes="(min-width: 1024px) 56vw, 0px"
              className="mx-auto h-auto max-h-[546px] w-full object-contain"
            />
          </div>
        </div>
      </div>
